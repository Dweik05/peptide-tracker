...
//   goes in:  app/(app)/report/page.js
//
// A printable, doctor-ready summary of the patient's protocol history.
// Renders as a light "document" sheet (not the dark app theme, so it prints
// cleanly on paper). The "Print / Save as PDF" button calls window.print();
// print-isolation CSS hides the app chrome and prints only the sheet.
//
// No PDF library — the browser's native print-to-PDF does the work, which
// keeps the build dependency-free and the layout reliable.
//
